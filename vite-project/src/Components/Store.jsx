        ...
        <div class="mx-auto max-w-5xl px-5 py-24">
          <div class="mx-auto flex flex-wrap items-center lg:w-4/5">
            ...
            <div class="mt-6 w-full lg:mt-0 lg:w-1/2 lg:pl-10">
              <h2 class="text-sm font-semibold tracking-widest text-gray-300">
                Nike
              </h2>
              <h1 class="my-4 text-3xl font-semibold text-slate-100">
                Nike Air Max 21A
              </h1>
              ...
              <div class="mb-5 mt-6 flex items-center border-b-2 border-gray-100 pb-5">
                ...
                <div class="ml-auto flex items-center">
                  ...
                  <div class="relative">
                    <select class="appearance-none bg-slate-700 rounded border border-gray-300 py-2 pl-3 pr-10 text-sm focus:border-black focus:outline-none focus:ring-2 focus:ring-black">
                      <option className="bg-slate-800">8 UK</option>
                      <option className="bg-slate-800">9 UK</option>
                      <option className="bg-slate-800">10 UK</option>
                    </select>
